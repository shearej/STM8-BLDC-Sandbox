 ...
 345                     ; 89 	  ptr = &data1;
 347                     ; 90 		ptr2 = (uint8_t *)&data1;
 349  0029 96            	ldw	x,sp
 350  002a 1c0003        	addw	x,#OFST-16
 351  002d 1f11          	ldw	(OFST-2,sp),x
 353                     ; 92     getData(ptr, memptr); //fill data struct with motor data
 ...
 808                     ; 203 }
 811  012c 81            	ret	
 839                     ; 205 void UART2_setup(void) 
 839                     ; 206 { 
 840                     	switch	.text
 841  012d               _UART2_setup:
 845                     ; 207     UART2_DeInit();
 847  012d cd0000        	call	_UART2_DeInit
 849                     ; 208 		UART2_Init(38400, 
 849                     ; 209 		           UART2_WORDLENGTH_8D, 
 849                     ; 210 							 UART2_STOPBITS_1, 
 849                     ; 211 							 UART2_PARITY_NO, 
 849                     ; 212 							 UART2_SYNCMODE_CLOCK_DISABLE, 
 849                     ; 213 							 UART2_MODE_TXRX_ENABLE); 
 ...
 863                     ; 215 		UART2_ITConfig(UART2_IT_RXNE, ENABLE); 
 865  0145 4b01          	push	#1
 866  0147 ae0255        	ldw	x,#597
 867  014a cd0000        	call	_UART2_ITConfig
 869  014d 9a            	rim	
 870  014e 84            	pop	a
 871                     ; 216 		enableInterrupts();
 875                     ; 218 		UART2_Cmd(ENABLE); 
